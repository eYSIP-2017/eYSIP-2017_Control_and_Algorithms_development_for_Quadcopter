		...
		float gz, float mx, float my, float mz, float *angle)
{
	...
	angle[1] = atan2(2.0f * (q[0] * q[1] + q[2] * q[3]), q[0] * q[0] - q[1] * q[1] - q[2] * q[2] + q[3] * q[3]) * 180/M_PI;
	angle[2] = (atan2(2.0f * (q[1] * q[2] + q[0] * q[3]), q[0] * q[0] + q[1] * q[1] - q[2] * q[2] - q[3] * q[3]) * 180/M_PI) + 180;
}
